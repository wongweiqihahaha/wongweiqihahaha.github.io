...
```{r, echo=TRUE, eval=TRUE}
historic_state_data_url <- "https://api.covidactnow.org/v2/states.timeseries.json?apiKey=28d8a28934654d62b7d329f589701203"
...
```{r, echo=TRUE, eval=TRUE}
data_to_plot <- tibble(
  Date_Alaska = time_series_cases$Alaska$date[seq(1, 1300, by = 100)],
